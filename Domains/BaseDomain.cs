...
namespace naukri.Domains
{
    public abstract class BaseDomain
    {
        public  BaseDomain()
         {
        this.SqlConnection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\shivani\computer\dotnet\ImportExport\App_Data\Database.mdf;Integrated Security=True;Connect Timeout=0");
